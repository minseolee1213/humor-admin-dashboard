...
const items: Array<{ href: string; label: string; description: string }> = [
  { href: '/admin/terms', label: 'Terms', description: 'Create, update, delete glossary terms' },
  { href: '/admin/caption-examples', label: 'Caption Examples', description: 'Curated caption examples for training/review' },
];

export default async function AdminCatalogLandingPage() {
  ...
  return (
    <AdminLayout userEmail={session?.user.email}>
      <div className="mb-8">
        ...
        <p className="text-base text-gray-600">Reference data and curated examples.</p>
      </div>
